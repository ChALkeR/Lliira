...
function analyze(data, times, meetings, values, quorum) {
  ...
  info.scores = {
    participation: {
      average: utility(info.probs.participation, 1),
      deviation: deviation(info.probs.participation),
      fairness: fairness(info.probs.participation),
    },
    interaction: {
      average: utility(info.probs.interaction, 1),
      deviation: deviation(info.probs.interaction),
      fairness: fairness(info.probs.interaction),
    }
  };
  return info;
}
